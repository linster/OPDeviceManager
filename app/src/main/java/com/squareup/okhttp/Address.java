...
public final class Address {
    ...
    public int hashCode() {
        int i = 0;
        int hashCode = ((((((((((this.proxy == null ? 0 : this.proxy.hashCode()) + 527) * 31) + this.uriHost.hashCode()) * 31) + this.uriPort) * 31) + (this.sslSocketFactory == null ? 0 : this.sslSocketFactory.hashCode())) * 31) + (this.hostnameVerifier == null ? 0 : this.hostnameVerifier.hashCode())) * 31;
