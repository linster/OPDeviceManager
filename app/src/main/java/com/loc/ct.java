...
public final class ct {
    ...
    protected static ct a(Context context) {
        ...
        ctVar.h = 0;
        ctVar.i = 0;
        ctVar.j = ((System.currentTimeMillis() + 28800000) / 86400000) * 86400000;
        try {
            ...
            try {
                ...
                if (toByteArray != null) {
                    if (toByteArray.length >= 22) {
                        ctVar.b = toByteArray[0] != null;
                        ctVar.c = (toByteArray[1] * 10) << 10;
                        ctVar.d = (toByteArray[2] * 10) << 10;
                        ctVar.e = toByteArray[3];
                        ctVar.f = toByteArray[4] * 10;
                        ctVar.g = toByteArray[5];
                        long b = b(toByteArray, 14);
                        if ((ctVar.j - b >= 86400000 ? 1 : 0) == 0) {
                            ctVar.j = b;
                            ctVar.h = a(toByteArray, 6);
                            ctVar.i = a(toByteArray, 10);
                        }
                    }
                }
