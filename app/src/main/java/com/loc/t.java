...
public class t {
    ...
    public static byte[] a() {
        ...
        try {
            ...
            String[] split2 = new StringBuffer(new String(o.a(new String(bArr)))).reverse().toString().split(",");
    ...
    private static byte[] d(byte[] bArr) throws IOException, Throwable {
        IOException e;
